...
* **`dashboard/Componentes`**: Pasta que armazena os arquivos reutilizaveis.
* **`dashboard/Core`**: lógica de negócios central e utilitários globais.
* **`dashboard/Data`**: Camada de acesso aos dados.
